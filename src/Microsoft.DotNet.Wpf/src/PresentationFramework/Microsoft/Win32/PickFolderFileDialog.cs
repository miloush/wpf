...
// 
// Description:
//              PickFolderFileDialog is a sealed class derived from FileDialog that
...
namespace Microsoft.Win32
{
    ...
    /// </summary>
    public sealed class PickFolderFileDialog : FileDialog
    {
        //---------------------------------------------------
        //
        // Constructors
        ...
        //   We add a constructor for our PickFolderDialog since we have
        //   additional initialization tasks to do in addition to the
        //   ones that FileDialog's constructor takes care of.
        /// <summary>
        ///  Initializes a new instance of the PickFolderDialog class.
        /// </summary>
        public PickFolderFileDialog() : base()
        {
            Initialize();
        }
        ...
        //
        //  We only perform PickFolderDialog() specific reset tasks here;
